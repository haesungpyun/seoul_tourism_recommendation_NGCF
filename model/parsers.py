...
parser.add_argument('-bt','--test_batch',type=int,default=256,help="Test Batch size")
...
parser.add_argument('-m','--mlp_ratio',type=float,default=0.5,help='choose ration between embedding and mlp weight from user features')
parser.add_argument('-n','--node_dropout',type=float,default=0.22,help='choose node dropout ratio')
